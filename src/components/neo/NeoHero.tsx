...
import { NeoShell, type NeoShellHandle } from "./NeoShell";
import type { NeoProcess } from "./commands";
...
export function NeoHero({ processes }: { processes: NeoProcess[] }) {
  ...
  const shellApi = useRef<NeoShellHandle>(null);

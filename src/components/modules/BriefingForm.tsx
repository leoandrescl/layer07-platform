  ...
  return (
    <section id="contact" className="py-32 px-8 max-w-4xl mx-auto">
      <div className="mb-16 border-l-2 border-zinc-800 pl-8">
        <span className="text-zinc-600 font-mono text-[10px] uppercase tracking-[0.4em]">Step {currentStep + 1} of 3</span>
        <h2 className="text-4xl font-medium tracking-tighter mt-2">Project Briefing</h2>
      </div>

      <form action={sendBriefing} className="bg-zinc-900/30 border border-zinc-800 p-8 md:p-12 min-h-[400px] flex flex-col justify-between">
        ...
        <div className="mt-12 flex justify-between items-center border-t border-zinc-800 pt-8">
          ...
          {currentStep === STEPS.length ? (
            <button type="submit" className="flex items-center gap-3 bg-white text-black px-8 py-3 font-mono text-[10px] uppercase tracking-[0.2em] font-bold hover:bg-zinc-200 transition-colors cursor-pointer">
